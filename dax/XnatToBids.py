                            ...
                            for scan_resources in os.listdir(os.path.join(sess_path, scan)):
                                for scan_file in os.listdir(os.path.join(sess_path, scan, scan_resources)):
                                    ...
                                    if scan_file.endswith('.nii.gz'):
                                        ...
                                        nii_file = scan_file
                                        bids_yaml(XNAT, project, scan_id, subj, res_dir, scan_file, uri, sess, nii_file, sess_idx, subj_idx)
...
def yaml_bids_filename(XNAT, data_type, scan_id, subj, sess, project, scan_file, scan_type, sess_idx, subj_idx):
    if data_type == "anat":
